prawn_document(:page_layout => :landscape) do |pdf|
 ...
 @brand_payments.each do |payment|
  ...
  pdf.table(table_data, :column_widths => [250, 125, 100, 150, 100], :cell_style => { inline_format: true,border_color: 'C0C0C0', padding: 4, align: :center, font: 'Helvetica', text_color: '5D5D5D', size: 12 }) do
