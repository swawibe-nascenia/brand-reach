prawn_document(:page_layout => :landscape) do |pdf|
 ...
 @campaigns.each do |campaign|
  ...
  pdf.table(table_data, :column_widths => [200, 75, 50, 75, 75, 125, 125], :cell_style => { inline_format: true, border_color: 'C0C0C0', padding: 4, align: :center, text_color: '5D5D5D', size: 11 }) do
