Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  # provider :twitter, ENV['TWITTER_KEY'], ENV['TWITTER_SECRET']
    ...
    provider :facebook, CONFIG[:fb_app_id], CONFIG[:fb_secret], scope: 'email,user_photos,user_location,public_profile,manage_pages,publish_actions,publish_pages,read_insights,user_posts,rsvp_event',
